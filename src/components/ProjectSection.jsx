...
const ProjectSection = () => {
  ...
  const projectImages = [
    { id: 1, title: "filmvault", imageSrc: "/images/filmvault.jpeg" },
    { id: 2, title: "mojito_Business", imageSrc: "/images/mojito.png" },
    { id: 3, title: "Shopping_Cart", imageSrc: "/images/shopping.png" },
    { id: 4, title: "Spotify_Clone", imageSrc: "/images/spotify.jpeg" },
  ];
  useEffect(() => {
    ...
    const horizontalScroll = gsap.to(".panel", {
      ...
      scrollTrigger: {
        ...
        invalidateOnRefresh: true, //recalculate width on resize
      },
    });
        ...
        <div ref={triggerRef} className="overflow-hidden opacity-0">
          ...
          >
            {projectImages.map((project) => (
              <div
                key={project.id}
                className="relative flex items-center panel  justify-center"
              >
                <div className="relative w-full h-full flex flex-col items-center justify-center p-4 sm:p-8 md:p-12">
                  <img
                    ...
                    alt="Projectimahe"
                  ></img>
                  <h2 className="project-title flex items-center gap-3 md:text-3xl text-sm md:fon-bold text-black mt-6 z-50 text-nowrap hover:text-gray-400 transition-colors duration-300 cursor-pointer">
                    {project.title}
                  </h2>
                </div>
              </div>
